...
function M.validate(snipDir)
	...
	if vim.bo.filetype == "" then
		u.notify("`nvim-tweezers` requires the current buffer to have a filetype.", "warn")
		return false
	end
		...
		local packageJsonStr = [[
{
	...
	"description": "This package.json has been generated by nvim-tweezers.",
	"name": "my-snippets"
}
]]
...
function M.bootstrapSnippetFile(ft, contents)
	local snipDir = require("tweezers.config").config.snippetDir
	local newSnipName = ft .. ".lua"
